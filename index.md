...
sections:
  ...
  - type: members.html
    ...
    paragraphs:
      ...
      - text: >
          I spent the last seven years in philanthropy leading a national youth development strategy as part of the [S.D. Bechtel, Jr. Foundation's](http://sdbjrfoundation.org/){:target="_blank"} spend-down. Through that work, the importance of building  organizational capacity, making data-informed decisions, and addressing organizational and field-wide inequities became clear, especially in helping organizations navigate uncertainties. Before that, I led nonprofit initiatives focused on creating equitable learning environments for young people through youth development and career pathway programs.
      - text: >
          I continue to do this work as a Board member of [Playworks Northern California](https://www.playworks.org/northern-california/){:target="_blank"} and [MENTOR California](https://www.mentorcaliforniayouth.org/){:target="_blank"}. 
      - text: >
      ...
      - text: >
          Past and current clients include: [America's Promise Alliance](https://www.americaspromise.org/){:target="_blank"}, [American Institutes for Research](https://www.air.org/){:target="_blank"},[Children's Funding Project](https://childrensfundingproject.org/){:target="_blank"}, [Forum for Youth Investment](https://forumfyi.org/){:target="_blank"}, [Grantmakers for Education](https://www.edfunders.org/){:target="_blank"}, [Hellman Foundation](https://www.hellmanfoundation.org/){:target="_blank"}, [Lilly Endowment](https://lillyendowment.org/){:target="_blank"}, [National Afterschool Association](https://naaweb.org/){:target="_blank"}, [Project Evident](https://www.projectevident.org/){:target="_blank"}, [The Learning Agenda](https://agenda4learning.com/){:target="_blank"}, [United Way of Fresno & Madera Counties](https://www.uwfm.org/){:target="_blank"}, [Wallace Foundation](https://www.wallacefoundation.org/){:target="_blank"} and [Wyman Center](https://wymancenter.org/){:target="_blank"}.         
